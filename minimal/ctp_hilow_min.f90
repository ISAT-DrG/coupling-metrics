...
!
   ...
   real(4), intent(in ), dimension(nlev_in,1)  ::  tlev_in   ! *** air temperature at pressure levels [K]
   real(4), intent(in ), dimension(nlev_in,1)  ::  qlev_in   ! *** specific humidity levels [kg/kg]
   real(4), intent(in ), dimension(nlev_in,1)  ::  plev_in   ! *** pressure levels [Pa]
